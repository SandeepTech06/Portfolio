    ...
    <section ref={sectionRef} id="contact" className="py-24">
      <div className="relative z-10 container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
          <Card data-gsap="contact" className="section-card p-8 relative overflow-hidden rounded-2xl transition-all duration-300 ease-out transform hover:-translate-y-2 hover:shadow-[var(--shadow-glow)] group cyber-grid-bg">
